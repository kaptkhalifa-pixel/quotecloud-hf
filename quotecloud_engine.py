...
def _build_pdf_html(payload):
    ...
    css = (
        ...
        "@page{size:A4;margin:0}img{-webkit-print-color-adjust:exact;print-color-adjust:exact;image-rendering:high-quality}body{-webkit-print-color-adjust:exact;print-color-adjust:exact}"
